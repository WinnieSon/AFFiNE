...
export const Renderers = {
  //#region Test
  TestMail: make(TestMail, 'Test Email from Palcon AI'),
  //#endregion

  //#region User
  SignIn: make(SignIn, 'Sign in to Palcon AI'),
  SignUp: make(SignUp, 'Your Palcon AI account is waiting for you!'),
  SetPassword: make(SetPassword, 'Set your Palcon AI password'),
  ChangePassword: make(ChangePassword, 'Modify your Palcon AI password'),
  ...
  TeamLicense: make(
    TeamLicense,
    'Your Palcon AI Self-Hosted Team Workspace license is ready'
  ),
  //#endregion
} as const;
