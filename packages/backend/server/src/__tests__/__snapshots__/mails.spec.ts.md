        ...
        <tr>␊
          <td>␊
            <p␊
              ...
              This is a test email from your Palcon AI instance.␊
            </p>␊
          </td>␊
        </tr>␊
      </tbody>␊
            ...
            <table␊
              ...
              <tbody style="width:100%">␊
                <tr style="width:100%">␊
                  <p␊
                    style="font-size:15px;line-height:24px;font-weight:400;font-family:Inter, Arial, Helvetica, sans-serif;margin-top:24px;margin-bottom:0;color:#141414">␊
                    You are signing in to Palcon AI. Here is your code:␊
                  </p>␊
                </tr>␊
              </tbody>␊
            </table>␊
    ...
    123456</pre␊
            ...
            <table␊
              ...
              <tbody style="width:100%">␊
                <tr style="width:100%">␊
                  <a␊
                    href="https://app.Palcon AI.pro/magic-link?token=123456&amp;email=test@test.com"␊
...
> Your Palcon AI account is waiting for you!
            ...
            <table␊
              ...
              <tbody style="width:100%">␊
                <tr style="width:100%">␊
                  <p␊
                    style="font-size:15px;line-height:24px;font-weight:400;font-family:Inter, Arial, Helvetica, sans-serif;margin-top:24px;margin-bottom:0;color:#141414">␊
                    You are signing up to Palcon AI. Here is your code:␊
                  </p>␊
                </tr>␊
              </tbody>␊
            </table>␊
...
> Modify your Palcon AI password
              ...
              <tbody style="width:100%">␊
                <tr style="width:100%">␊
                  <p␊
                    ...
                    with your Palcon AI account.<br />To complete this process, please␊
      ...
      <tbody>␊
        <tr>␊
          <td>␊
            <p␊
              style="font-size:20px;line-height:28px;font-weight:600;font-family:Inter, Arial, Helvetica, sans-serif;margin-top:24px;margin-bottom:0;color:#141414">␊
              Verify your current email for Palcon AI␊
            </p>␊
          </td>␊
        </tr>␊
      </tbody>␊
              ...
              <tbody style="width:100%">␊
                <tr style="width:100%">␊
                  <p␊
                    style="font-size:15px;line-height:24px;font-weight:400;font-family:Inter, Arial, Helvetica, sans-serif;margin-top:24px;margin-bottom:0;color:#141414">␊
                    You recently requested to change the email address associated␊
                    with your Palcon AI account. To complete this process, please click␊
        ...
        <tr>␊
          <td>␊
            <p␊
              ...
              you&#x27;re using␊
              <span style="font-weight:600">test@Palcon AI.pro</span> to log in the␊
              next time.␊
            </p>␊
          </td>␊
        </tr>␊
...
> test@test.com invited you to join Test Workspace
    ...
    <link␊
      rel="preload"␊
      as="image"␊
      href="https://app.Palcon AI.pro/favicon-192.png" /><!--$-->␊
    <table␊
      align="center"␊
      width="100%"␊
      border="0"␊
              ...
              <tbody style="width:100%">␊
                <tr style="width:100%">␊
                  <p␊
                    ...
                    to join␊
                    <img␊
                      src="https://app.Palcon AI.pro/favicon-192.png"␊
                      alt="avatar"␊
            ...
            <table␊
              ...
              <tbody style="width:100%">␊
                <tr style="width:100%">␊
                  <p␊
                    style="font-size:15px;line-height:24px;font-weight:400;font-family:Inter, Arial, Helvetica, sans-serif;margin-top:24px;margin-bottom:0;color:#141414">␊
                    Thank you for your support of Palcon AI. We hope to see you again␊
                    in the future.␊
                  </p>␊
                </tr>␊
              </tbody>␊
